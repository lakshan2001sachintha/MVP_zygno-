...
export const fetchTeachersListFn = createServerFn({ method: "GET" })
  .handler(async () => {
    const supabase = getSupabaseServerClient();
...
export const createModuleFn = createServerFn({ method: "POST" })
  .validator((data: any) => data as { title: string; description?: string; credits: number; teacherId?: string })
  .handler(async ({ data }) => {
    const supabase = getSupabaseServerClient();
...
export const updateModuleFn = createServerFn({ method: "POST" })
  .validator((data: any) => data as { id: string; title: string; description?: string; credits: number; teacherId?: string })
  .handler(async ({ data }) => {
    const supabase = getSupabaseServerClient();
