    ...
    <div className="mt-4 space-y-3">
      {type === "error" && (
        <div className="demo-alert demo-alert-danger flex items-center gap-2">
          ...
          <span className="text-sm font-medium">Error captured and sent to Sentry</span>
        </div>
      )}
      ...
      {type === "success" && (
        <div className="demo-alert flex items-center gap-2">
          ...
          <span className="text-sm font-medium">Trace completed successfully</span>
        </div>
      )}
      ...
      <div className="mx-auto max-w-5xl">
        <div className="mb-16 text-center">
          <div className="mb-8 inline-flex items-center gap-4">
            ...
            <div className="text-left">
              ...
              <p className="demo-muted text-sm">Error monitoring & performance tracing</p>
            </div>
          </div>
          ...
          <div className="demo-alert mb-8 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="demo-muted mt-1 text-sm">
                Set the <code>VITE_SENTRY_DSN</code> environment variable to enable error tracking
        ...
        <div className="mt-12 text-center">
          <p className="demo-muted text-sm">
            This page uses <code>@sentry/tanstackstart-react</code> for full-stack error monitoring.
            <br />
            <a
