...
We embrace modern development workflows, but we want to evaluate _your_ engineering decisions and how you collaborate with AI, rather than evaluating an AI's ability to generate an app from scratch.
...
- _Note:_ We encourage you to use Supabase Auth for managing these users. You don't have to build a complex JWT/OAuth flow from scratch; setting up basic email/password authentication or magic links with Supabase is perfectly fine.
